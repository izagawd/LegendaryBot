...
public abstract class GearStat
{
    ...
    [NotMapped] public static Type AttackPercentageType { get; } = typeof(AttackPercentageGearStat);
    ...
    [NotMapped] public static IEnumerable<Type> AllGearStatTypes { get; }

    [NotMapped] public abstract StatType StatType { get; }
    ...
    {
        Value += BasicFunctions.GetRandomNumberInBetween(GetMinimumSubstatLevelIncrease(rarity),
