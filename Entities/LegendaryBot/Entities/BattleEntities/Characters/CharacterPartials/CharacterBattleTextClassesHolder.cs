        ...
        public override string Text
        {
            get
            {
                ...
                if (_statusEffects.Count > 1)
                    noun = "have";
                var concatenated = BasicFunctions.CommaConcatenator(_affectedCharacters
                ...
                var statusEffectsString = BasicFunctions.CommaConcatenator(countTracker.Select(i =>
                {
    ...
    private class CombatReadinessChangeBattleText : BattleText
    {
        ...
        public override string Text
        {
            get
            {
                ...
                return BasicFunctions.CommaConcatenator(_affectedCharacters
                           .Select(i => i.NameWithAlphabet))
        ...
        public override string Text
        {
            get
            {
                ...
                if (_extraTurners.Count > 1)
                    noun = "have";
                return BasicFunctions.CommaConcatenator(_extraTurners
        ...
        public override string Text
        {
            get
            {
                ...
                if (_revivedCharacters.Count > 1)
                    noun = "have";
                return BasicFunctions.CommaConcatenator(_revivedCharacters
        ...
        public override string Text
        {
            get
            {
                ...
                if (_deadCharacters.Count > 1)
                    noun = "have";
                return BasicFunctions.CommaConcatenator(_deadCharacters
