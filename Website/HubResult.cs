...
public class HubResult
{
    ...
    public static HubResult Success(string? message = null)
    {
        return new HubResult(true, message);
    }

    public static HubResult Failure(string? message = null)
    {
        return new HubResult(false, message);
    }
}
