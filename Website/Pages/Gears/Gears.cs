...
public partial class Gears
{
    public class GearPageDto
    {
        ...
        public void Setup()
        {
            foreach (var i in Gears.SelectMany(i => i.GearStatDtos)) i.Name = GearStatNameMapper[i.TypeId];
        }
    }
    ...
    public class GearStatDto
    {
        ...
        [JsonPropertyName("1")] public float Value { get; set; }

        [JsonPropertyName("2")] public int TypeId { get; set; }

        [JsonPropertyName("3")] public bool IsMainStat { get; set; }

        [JsonPropertyName("4")] public bool IsPercentage { get; set; }
    }
    ...
    public class GearDto
    {
        ...
        [JsonPropertyName("6")] public GearStatDto[] GearStatDtos { get; set; }

        [JsonPropertyName("7")] public int? OwnerTypeId { get; set; }
    }
}